(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    var accumulator = _.reduce(collection, function(accumulator, value) {
      if (!accumulator) {
        return false;
      }
      if (iterator(value)) {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (argsUsed[args] === undefined) {
        result = func.apply(this, arguments);
        argsUsed[args] = result;
        return result;
      } else {
  ...
  _.shuffle = function(array) {
    ...
    while (length > 0) {
      ...
      randArray.push(newArray[index]);
      newArray.splice(index, 1);
      length--;
    }
    if (JSON.stringify(randArray) === JSON.stringify(array)) {
